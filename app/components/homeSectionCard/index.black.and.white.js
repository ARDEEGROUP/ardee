...
export default function HomeSectionCard(props) {
  ...
  return (
    <div
      ...
      ref={domRef}
      className={`cursor-default rounded-2xl min-h-[400px] mt-10 ${classes} shadow-xl relative border border-solid border-zinc-700/50 hover:border-white hover:shadow-2xl grayscale-card delay-200 ${
