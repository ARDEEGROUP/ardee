...
export default function Sports() {
  ...
  const racquetClubGgnImages = [
    "sports/arc-ggn/ardee-racquet-club-1",
    "sports/arc-ggn/ardee-racquet-club-2",
    "sports/arc-ggn/ardee-racquet-club-3",
    "sports/arc-ggn/ardee-racquet-club-4",
    "sports/arc-ggn/ardee-racquet-club-5",
    "sports/arc-ggn/ardee-racquet-club-6",
    // "sports/arc-new-delhi/ardee-racquet-club-4",
    // "sports/arc-new-delhi/ardee-racquet-club-5",
  ];

  const racquetClubGoaImages = [
    "sports/arc-goa/ardee-racquet-club-1",
    "sports/arc-goa/ardee-racquet-club-2",
    "sports/arc-goa/ardee-racquet-club-3",
    "sports/arc-goa/ardee-racquet-club-4",
    "sports/arc-goa/ardee-racquet-club-5",
  ];

  const sportsClubImages = ["sports/ardee-sports-club-1"];
  ...
  return (
    <div className="w-full container mx-auto p-2 md:p-3 lg:p-5 lg:mb-10 bg-zinc-950 lg:bg-transparent lg:rounded-b-xl">
      <div className="w-full">
        <HeroBannerCard item={sportsHeroBanner} index={0} />
      </div>
        ...
        <div className="flex items-start flex-wrap w-full">
          ...
          <div className="px-5 pb-10 lg:pb-0 lg:px-0 bg-gradient-to-b from-zinc-400/0 via-zinc-950/70 to-zinc-950 rounded-b-xl lg:to-transparent lg:via-transparent w-full lg:w-1/2 flex flex-col lg:pl-10 z-50">
            ...
            <div className="mt-5 max-w-prose text-zinc-100 flex flex-col gap-y-4 text-xl">
              {ARDEE_SPORTS_CLUB_FEATURES.map((item, index) => (
                <div key={index} className="h-full">
                  <IconListItem
                    item={item}
                    iconGetter={getArdeeSportsClubIcon}
                  />
                </div>
              ))}
            </div>
            ...
            <div className="mt-5 max-w-prose text-zinc-100 flex flex-col gap-y-4 text-xl">
              {TEAM_ARDEE_MASTERS_FEATURES.map((item, index) => (
                <div key={index} className="h-full">
                  <IconListItem
                    item={item}
                    iconGetter={getTeamArdeeMastersIcon}
                  />
                </div>
              ))}
            </div>
